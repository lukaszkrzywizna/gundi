    ...
    partial record CSharpUnion
    {
        ...
        public override int GetHashCode()
        {
            return tag switch
            {
                ...
                3 => System.HashCode.Combine(this.f),
                4 => System.HashCode.Combine(this.t),
                _ => throw new ArgumentOutOfRangeException(nameof(tag), tag, "Union has undefined state!")
            };
        }

        public virtual bool Equals(CSharpUnion? other)
        {
            return tag switch
            {
                ...
                3 => other.IsF() && System.Collections.Generic.EqualityComparer<Gundi.Tests.Record>.Default.Equals(this.f, other.CastToF()),
                4 => other.IsT() && System.Collections.Generic.EqualityComparer<(System.String, System.Int32)>.Default.Equals(this.t, other.CastToT()),
                _ => throw new ArgumentOutOfRangeException(nameof(tag), tag, "Union has undefined state!")
            };
        }
